...
Replace the highest-risk assumptions in the Nepalgunj flagship plan with dated, reviewable evidence while building an opted-in pre-launch audience through Facebook, Instagram, TikTok, YouTube, Google Business and WhatsApp.

Confidential distributor margins, credit limits, individual retailer sales, mystery-shop identities and landlord negotiations remain internal unless written permission authorises publication.
...
Request the same schedule from at least three authorised distributors:

- Brand and authorised territory
- Net invoice price and effective dealer margin
- Target-linked incentives and payment timing
- Credit period, credit limit and BG invocation process
- Required BG wording, bank and renewal conditions
- Price protection after MRP reductions
- Slow-stock rotation and returns
- Defective-on-arrival window, evidence and replacement timing
- Warranty intake, transport and service responsibility
- Demonstration-unit pricing and replacement
- Launch allocation and seasonal campaign obligations
- Marketing-development funds and claim process
...
- Two models below NPR 20,000
- Four models from NPR 20,000–30,000
- Three models from NPR 30,000–50,000
- One model from NPR 50,000–80,000
- One authorised iPhone
...
1. Dhamboji Chowk/core corridor
...
Obtain at least five written or message-verifiable quotations. Record:

- Exact address and usable ground-floor area
- Frontage and visibility
- Monthly rent, deposit and advance
- Escalation, lease term and break clause
- Fit-out period and landlord contribution
- Parking/loading and delivery access
- Electricity capacity, backup feasibility and internet
- Signage rights and operating-hour restrictions
- Fire, accessibility, drainage/flood and building risks
- Maintenance, taxes and common charges

Do not publish offers during negotiation.

## Last-30-day sell-through request
...
1. **Nepalgunj Chooses** — anonymous budget, brand and service findings.
2. **Phone Basket Friday** — neutral product comparisons based on the standard basket.
3. **Where Should We Open?** — accessibility and parking polls supported by traffic counts.
4. **Authorised or Grey?** — MDMS, invoice and Nepal-warranty education.
5. **Building the Service Lounge** — how customer problems shape setup, repair and warranty workflows.
6. **You Asked, We Designed** — final explanation of how verified findings shaped the store.
...
The final model must replace assumptions with:
...
- Downside sales case and working-capital requirement

The owner, accountant and relevant professional reviewers must approve the model before lease, construction and main inventory commitments.
