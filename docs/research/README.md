...
| 6. EMI/BNPL | [DEC-0016](../../decisions/DEC-0016-financing-and-emi-strategy.md), [finance system](../milestones/v0.8-finance/v0.8-emi-partner-operating-model.md) | Operating concept exists; current bank product/merchant-economics study incomplete | D plus open commercial facts | Create current partner matrix, eligibility, fees, settlement and launch sequence |
