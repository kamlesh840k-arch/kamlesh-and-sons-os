...
- [`milestones/`](milestones/README.md) — canonical documentation grouped by release version, v0.1 through v1.0.
...
- [`research/`](research/README.md) — canonical cross-market research index, evidence taxonomy, backlog and reusable studies.
- Root-level documents — cross-cutting decision log, consolidation registry, documentation standards and innovation vault.

## Rule

Put milestone-specific documents in the applicable `milestones/vX.Y-*` folder. Keep cross-cutting governance, decision history and long-range planning outside the milestone folders. Do not create a duplicate document when an existing canonical record can be updated and cross-referenced.
